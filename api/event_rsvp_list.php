<?php
// Admin-only: attendee list (registered + waitlisted) for a Company Calendar "Event".
...
$stmt = local_db()->prepare(
    "SELECT agent_name, agent_email, status, rsvped_at FROM events_rsvps WHERE event_id=? ORDER BY status, rsvped_at"
);
