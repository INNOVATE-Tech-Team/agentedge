...
if ($listingKey === '') {
    echo json_encode(['ok' => false, 'error' => 'listing_key is required']);
    exit;
}
...
$url   = $base . '/public/agentedge/buyback/hotdeals/share-text?' . $qs;

$payload = json_encode(['listing_key' => $listingKey]);
