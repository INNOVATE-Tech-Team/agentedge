...
if ($action === 'create') {
    ...
    local_db()->prepare("INSERT INTO training_events (event_id, capacity, reg_description, reg_slug) VALUES (?,?,?,?) ON CONFLICT(event_id) DO UPDATE SET capacity=excluded.capacity, reg_description=excluded.reg_description, reg_slug=excluded.reg_slug")
...
// ── Update ────────────────────────────────────────────────────────────────────
    ...
    $db = local_db();
    $db->prepare("INSERT INTO training_events (event_id, capacity, reg_description, reg_slug) VALUES (?,?,?,?) ON CONFLICT(event_id) DO UPDATE SET capacity=excluded.capacity, reg_description=excluded.reg_description, reg_slug=excluded.reg_slug")
