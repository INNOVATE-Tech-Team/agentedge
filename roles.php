...
// searching for that type of property. Phase 1 scope -- admin/BIC only.
// Widening to all agents is gated on per-use billing existing first (see
// the coastline-server hot-deal-alerts Phase 2 plan) so open access can't
// run up real AirROI/data costs with no cost recovery.
