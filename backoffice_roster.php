...
function reloadRoster() {
    try { sessionStorage.setItem('ae_roster_scroll', String(window.scrollY)); } catch(e) {}
    window.location.reload();
}
(function restoreRosterScroll() {
    let saved;
    try { saved = sessionStorage.getItem('ae_roster_scroll'); } catch(e) { saved = null; }
    if (saved === null) return;
    try { sessionStorage.removeItem('ae_roster_scroll'); } catch(e) {}
