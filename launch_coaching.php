    ...
    <main class="wrap">
      ...
      <div class="lc-card">
        ...
        <table class="roster-table" id="roster-table">
          <thead>
            <tr>
              <th>Agent</th><th>Email</th><th>Phone</th><th>State</th><th>Office</th><th>Coach</th><th>Start Date</th>
          ...
          <tbody>
            ...
            <tr data-id="<?= (int)$r['id'] ?>" data-status="<?= h($r['status']) ?>"
              ...
              <td><input class="cell-input wide" type="email" data-field="agent_email" value="<?= h($r['agent_email']) ?>" placeholder="email@example.com"></td>
              <td><input class="cell-input" data-field="agent_phone" value="<?= h($r['agent_phone']) ?>" placeholder="—"></td>
            ...
            <?php endforeach; ?>
            <?php if (!$roster): ?>
            <tr><td colspan="11" style="text-align:center;color:var(--faint);padding:24px">No one on the coaching roster yet.</td></tr>
            <?php endif; ?>
          </tbody>
        </table>
        </div>
